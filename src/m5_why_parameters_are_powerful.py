...
def main():
    ...
    #better_draw_circles(rg.Point(100, 50), 30)
    #even_better_draw_circles(rg.Point(20, 80), 40, 8, 'green', 10)
    even_better_draw_circles(rg.Point(70, 60), 20, 4, 'black', 80)
    even_better_draw_circles(rg.Point(-110, 60), 20, 4, 'black', 80)
    even_better_draw_circles(rg.Point(-20, -50), 30, 4, 'black', 80)
    #mickey mouse
    window.update()
...
def even_better_draw_circles(point, radius, bob, color, thickness):
    ...
    for k in range(bob):  # k becomes 1, 2, 3, ... 10
